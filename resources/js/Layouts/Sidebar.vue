<script setup>
  ...
  const activeMaster = route().current('users.*') || route().current('roles.*') || route().current('product-category.*') || route().current('consignor.*') || route().current('product.*')  || route().current('brand.*') || route().current('group-coa.*') || route().current('coa.*') || route().current('color.*') || route().current('banner.*') || route().current('gallery.*') || route().current('member.*') || route().current('group-asset.*') || route().current('asset.*') || route().current('event.*') || route().current('promo-subscribe.*') || route().current('review.*') || route().current('suggestion.*') || route().current('message.*') || route().current('subscribe.*') || route().current('review-product.*')  ? '' : 'hidden'
  ...
  const activeTransaction = route().current('pos.*') || route().current('konsinyasi.*')  || route().current('order.*') || route().current('closing-day.*') ? '' : 'hidden'
...
<template>
  <aside
    id="sidebar"
    class="fixed top-0 left-0 z-20 md:flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width"
    aria-label="Sidebar"
  >
    <div
          ...
          <ul class="pb-2 space-y-2">
            ...
            <li>
              ...
              <ul id="dropdown-crud" :class="activeMaster" class="space-y-2 py-2">
                ...
                <li>
                  <Link :href="route('consignor.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('consignor.*')
                        ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                  "
                ...
                <li>
                  <Link :href="route('event.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"
                ...
                <li>
                  <Link :href="route('subscribe.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('subscribe.*')
                        ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                  "
                  >
                ...
                <li>
                  <Link :href="route('review-product.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('review-product.*')
                    ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                    "
                    >{{ lang().label.review_product }}
                  </Link>
                </li>
                <li>
                  <Link :href="route('suggestion.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"
                ...
                <li>
                  <Link :href="route('message.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"
            ...
            <li>
              ...
              <ul id="dropdown-transaction" :class="activeTransaction" class="space-y-2 py-2">
                ...
                <li>
                  <Link :href="route('konsinyasi.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('konsinyasi.*')
                        ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                  "
                ...
                <li>
                  <Link :href="route('order.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"
                ...
                <li>
                  <Link :href="route('closing-day.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('closing-day.*')
                        ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                  "

                  >
                    {{ lang().label.closing_day }}
                  </Link>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul id="dropdown-asset" :class="activeAsset" class="space-y-2 py-2">
                ...
                <li>
                  <Link :href="route('penjualan-asset.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('penjualan-asset.*')
                        ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                  "
            ...
            <li>
              ...
              <ul id="dropdown-setting" :class="activeSetting" class="space-y-2 py-2">
                ...
                <li>
                  <Link :href="route('delivery-shipping.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('delivery-shipping.*')
                        ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                  "
                  >
                ...
                <li>
                  <Link :href="route('faq.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"
                ...
                <li>
                  <Link :href="route('voucher.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"
                ...
                <li>
                  <Link :href="route('authentication.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('authentication.*')
                        ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                  "
                  >
                    {{ lang().label.authentication }}
                  </Link>
                </li>
                <li>
                  <Link :href="route('work-with-us.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('work-with-us.*')
                        ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                  "
                  >
                    {{ lang().label.work_with_us }}
                  </Link>
                </li>
                <li>
                  <Link :href="route('consignment.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('consignment.*')
                        ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                  "
                  >
                ...
                <li>
                  <Link :href="route('profile.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"
                ...
                <li>
                  <Link :href="route('agreement.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('agreement.*')
                        ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                  "

                  >
                    {{ lang().label.agreement }}
                  </Link>
                </li>
                <li>
                  <Link :href="route('operational.index')" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"

                  :class="
                    route().current('operational.*')
                        ? 'bg-gray-100 dark:bg-gray-700'
                        : ''
                  "
