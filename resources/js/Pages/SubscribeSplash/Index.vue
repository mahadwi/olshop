...
import Edit from "@/Pages/SubscribeSplash/Edit.vue";
import Create from "@/Pages/SubscribeSplash/Create.vue";
import Delete from "@/Pages/SubscribeSplash/Delete.vue";
...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("subscribe.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
                ...
                <div class="col-span-2">
                    ...
                    >
                                ...
                                <div class="overflow-hidden shadow">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                            <tr
                                            v-for="(subscribe, index) in subscribes.data"
                                            :key="index"
                                        ...
                                        >
                                                ...
                                                <td class="w-32">
                                                    <img :src="subscribe.image_url" :alt="subscribe.title">
                                                </td>
                        ...
                        <div class="flex justify-between items-center p-2 border-t border-slate-200 dark:border-slate-700">
                            <Pagination :links="props.subscribes" :filters="data.params" />
                        </div>
                    </div>
                </div>
            </div>
