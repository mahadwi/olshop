...
watch(
    () => _.cloneDeep(),
    debounce(() => {
        router.get(route("consignment.index"), {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
            ...
            <div class="grid mb-10 px-4 pt-6 grid-cols-1 dark:bg-gray-900">
                <div class="col-span-2">
                    ...
                    >
                        ...
                        <button v-if="props.consignment.length == 0" @click="data.createOpen = true"
                                ...
                                <div class="overflow-hidden shadow">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                            <tr
                                            v-for="(consign, index) in consignment"
                                            :key="index"
                                            class="hover:bg-gray-100 dark:hover:bg-gray-700"
                                        >
                                                <td class="tbl-column pl-4"> {{ ++index }}</td>
                                                <td class="tbl-column"> {{ consign.title }}</td>
                                                <td class="tbl-column" v-html="truncate(consign.description, 25)">
                                                </td>
