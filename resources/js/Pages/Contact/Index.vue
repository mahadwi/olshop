...
import Edit from "@/Pages/Contact/Edit.vue";
import Create from "@/Pages/Contact/Create.vue";
import Delete from "@/Pages/Contact/Delete.vue";
...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("contact.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
            ...
            <div class="grid mb-10 px-4 pt-6 grid-cols-1 dark:bg-gray-900">
                <div class="col-span-2">
                    ...
                    >
                        ...
                        <button v-if="props.contacts.data.length == 0" @click="data.createOpen = true"
