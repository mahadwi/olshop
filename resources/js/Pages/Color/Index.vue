...
import Create from "@/Pages/Color/Create.vue";
import Delete from "@/Pages/Color/Delete.vue";
...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("color.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
                ...
                <div class="col-span-2">
                    ...
                    >
                                ...
                                <div class="overflow-hidden shadow">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        ...
                                        >
                                                ...
                                                <td class="tbl-column"> {{ color.name }}</td>
                        ...
                        <div class="flex justify-between items-center p-2 border-t border-slate-200 dark:border-slate-700">
                            <Pagination :links="props.colors" :filters="data.params" />
                        </div>
                    </div>                   
                </div>
            </div>            
