...
import Edit from "@/Pages/Banner/Edit.vue";
import Create from "@/Pages/Banner/Create.vue";
import Delete from "@/Pages/Banner/Delete.vue";
...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("banner.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
