...
import Edit from "@/Pages/Review/Edit.vue";
import Create from "@/Pages/Review/Create.vue";
import Delete from "@/Pages/Review/Delete.vue";
...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("review.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        <thead class="bg-gray-100 dark:bg-gray-700">
                                            <tr>
                                                ...
                                                <th scope="col" class="tbl-head">
                                                    {{ lang().label.display_on_homepage }}
                                                </th>
                                                <th scope="col" class="tbl-head">
                                                    {{ lang().label.image }}
                                                </th>
                                        ...
                                        >
                                                ...
                                                <td class="tbl-column"> {{ review.name }}</td>
                                                <td class="tbl-column"> 
                                                    <Rating v-model="review.rating" readonly :cancel="false" />
                                                </td>
                                                <td class="tbl-column" v-html="truncate(review.review, 25)">
                                                </td>
                                                <td class="tbl-column"> {{ review.is_display ? 'Yes' : 'No' }}</td>
                                                <td class="w-32">
