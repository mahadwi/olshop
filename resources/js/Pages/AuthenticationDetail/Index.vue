...
import Create from "@/Pages/AuthenticationDetail/Create.vue";
import Delete from "@/Pages/AuthenticationDetail/Delete.vue";
import Edit from "@/Pages/AuthenticationDetail/Edit.vue";

const { _, debounce, pickBy } = pkg;
const emit = defineEmits(["close"]);

const props = defineProps({
    detailAuthentications: Object,
    detailAuthenticationsPaginate: Object,
...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("authentication.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
...
<template>
    ...
    <Delete
        ...
        :authentication="data.authenticationDetails"
    />
    <Edit
        :show="data.editOpen"
                ...
                <div class="col-span-2">
                    ...
                    >
                                ...
                                <div class="overflow-hidden shadow">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                            <tr
                                            v-for="(authentication, index) in detailAuthentications"
                                            :key="index"
                                        ...
                                        >
                                                ...
                                                <td class="w-32">
                                                    <img :src="authentication.image_url" :alt="authentication.name">
                                                </td>
                                                <td class="tbl-column space-x-2 whitespace-nowrap text-center">
                                                    <button @click="
                                                                (data.editOpen = true),
                                                                    (data.authenticationDetails = authentication)
                        ...
                        <div class="flex justify-between items-center p-2 border-t border-slate-200 dark:border-slate-700">
                            <Pagination :links="props.detailAuthenticationsPaginate" :filters="data.params" />
                        </div>
                    </div>
                </div>
            </div>
