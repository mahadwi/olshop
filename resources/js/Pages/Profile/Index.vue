...
import Create from "@/Pages/Profile/Create.vue";
import Delete from "@/Pages/Profile/Delete.vue";
            ...
            <div class="grid mb-10 px-4 pt-6 grid-cols-1 dark:bg-gray-900">
                <div class="col-span-2">
                    ...
                    >
                        ...
                        <button v-if="props.profiles.data.length == 0" @click="data.createOpen = true"
                                ...
                                <div class="overflow-hidden shadow">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        ...
                                        >
                                                ...
                                                <td class="tbl-column"> {{ profile.name }}</td>
                                                <td class="tbl-column"> {{ `${profile.subdistrict.city.province.name}, ${profile.subdistrict.city.name}, , ${profile.subdistrict.name}` }}</td>
                                                <td class="w-32">
                        ...
                        <div class="flex justify-between items-center p-2 border-t border-slate-200 dark:border-slate-700">
                            <Pagination :links="props.profiles" :filters="data.params" />
                        </div>
                    </div>
                </div>
            </div>
