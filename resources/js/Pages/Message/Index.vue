...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("message.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
                ...
                <div class="col-span-2">
                    ...
                    >
                                ...
                                <div class="overflow-hidden shadow">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        ...
                                        >
                                                ...
                                                <td class="tbl-column"> {{ message.firstName }}</td>
                                                <td class="tbl-column"> {{ message.email }}</td>
                                                <td class="tbl-column"> {{ message.handphone }}</td>
                                                <td class="tbl-column" v-html="truncate(message.subject, 25)">
                                                </td>
                        ...
                        <div class="flex justify-between items-center p-2 border-t border-slate-200 dark:border-slate-700">
                            <Pagination :links="props.messages" :filters="data.params" />
                        </div>
                    </div>
                </div>
            </div>
