...
import Edit from "@/Pages/AboutUs/Edit.vue";
import Create from "@/Pages/AboutUs/Create.vue";
import Delete from "@/Pages/AboutUs/Delete.vue";
...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("about.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
            ...
            <div class="grid mb-10 px-4 pt-6 grid-cols-1 dark:bg-gray-900">
                <div class="col-span-2">
                    ...
                    >
                        ...
                        <button v-if="props.abouts.data.length == 0" @click="data.createOpen = true"
                                ...
                                <div class="overflow-hidden shadow">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                            <tr
                                            v-for="(about, index) in abouts.data"
                                            :key="index"
