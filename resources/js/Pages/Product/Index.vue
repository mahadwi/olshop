            ...
            <div class="grid mb-10 px-4 pt-6 grid-cols-1 dark:bg-gray-900">
                <div class="col-span-2">
                    ...
                    >
                        ...
                        <Link :href="route('product.create')" class="btn-primary mb-2">
                            {{ lang().button.add }}
                        </Link>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        <thead class="bg-gray-100 dark:bg-gray-700">
                                            <tr>
                                                ...
                                                <th scope="col" class="tbl-head">
                                                    {{ lang().label.name }} {{ lang().label.product }}
                                                </th>
                                                <th scope="col" class="tbl-head">
                                                    {{ lang().label.brand }}
                                                </th>
                                        ...
                                        >
                                                ...
                                                <td class="tbl-column"> {{ priceFormat(product.price_usd) }}</td>
                                                ...
                                                <td class="p-4 space-x-2 whitespace-nowrap">
                                                    <Link :href="route('product.edit', product.id)" class="btn-primary">
