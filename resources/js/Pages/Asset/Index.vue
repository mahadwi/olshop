...
import Edit from "@/Pages/Asset/Edit.vue";
import Delete from "@/Pages/Asset/Delete.vue";
...
const groupAsset = props.groupAsset.map((data) => ({
    label: data.name,
    value: data.id
}))
...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("asset.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
                ...
                <div class="col-span-2">
                    ...
                    >
                        ...
                        <div class="flex justify-between items-center p-2 border-t border-slate-200 dark:border-slate-700">
                            <Pagination :links="props.assets" :filters="data.params" />
                        </div>
                    </div>                   
                </div>
            </div>            
