...
watch(
    () => _.cloneDeep(),
    debounce(() => {
        router.get(route("authentication.index"), {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <Create
            ...
            :title="props.title"
            :authentication="props.authentications"
            :authenticationDetail="props.detailAuthentications"
        />
        <Delete
            ...
            <div class="grid mb-10 px-4 pt-6 grid-cols-1 dark:bg-gray-900">
                <div class="col-span-2">
                    ...
                    >
                        ...
                        <button v-if="props.authentications.length == 0" @click="data.createOpen = true"
