                ...
                <div class="col-span-2">
                    ...
                    >
                                ...
                                <div class="overflow-hidden shadow">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        ...
                                        >
                                                ...
                                                <td class="tbl-column"> {{ customer.name }}</td>
                                                <td class="tbl-column"> {{ customer.email }}</td>
                                                <td class="tbl-column"> {{ customer.phone }}</td>
                                                ...
                                                <td class="p-4 space-x-2 whitespace-nowrap">
                                                    ...
                                                    <button v-if="customer.penjualan_asset.length == 0" @click="
                        ...
                        <div class="flex justify-between items-center p-2 border-t border-slate-200 dark:border-slate-700">
                            <Pagination :links="props.customers" :filters="data.params" />
                        </div>
                    </div>                   
                </div>
            </div>            
