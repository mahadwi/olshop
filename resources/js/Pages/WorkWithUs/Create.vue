                                ...
                                <div class="p-6">
                                    <form @submit.prevent="createSection3">
                                        <div class="my-6 space-y-4">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    <FwbInput v-model="formSection3.title" :placeholder="lang().label.title" :label="lang().label.title" />
                                                    <InputError class="mt-2" :message="formSection3.errors.title" />
                                                </div>
                                                <div>
                                                    <FwbInput v-model="formSection3.title_en" :placeholder="lang().label.title_en" :label="lang().label.title_en" />
                                            ...
                                            <div>
                                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"> {{lang().label.description}} </label>
                                                <QuillEditor theme="snow" toolbar="full" content-type="html" :placeholder="lang().label.description" v-model:content="formSection3.description" />
                                                <InputError class="mt-2" :message="formSection3.errors.description" />
                                            </div>

                                            <div>
                                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"> {{lang().label.description_en}} </label>
                                                <QuillEditor theme="snow" toolbar="full" content-type="html" :placeholder="lang().label.description_en" v-model:content="formSection3.description_en" />
                                            ...
                                            <div class="flex justify-center">
                                                ...
                                                <PrimaryButton
                                                    type="submit"
                                                    class="ml-3"
                                                    :class="{ 'opacity-25': formSection3.processing }"
                                                    :disabled="formSection3.processing"
                                                >
                                                    {{
