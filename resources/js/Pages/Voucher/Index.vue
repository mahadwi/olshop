...
import Edit from "@/Pages/Voucher/Edit.vue";
import Create from "@/Pages/Voucher/Create.vue";
import Delete from "@/Pages/Voucher/Delete.vue";
...
const useFor = Object.values(props.useFor).map((data) => ({
    name: data,
    value: data,
}));
...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("voucher.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
                ...
                <div class="col-span-2">
                    ...
                    >
                                ...
                                <div class="overflow-hidden shadow">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        ...
                                        >
                                                ...
                                                <td class="tbl-column"> {{ voucher.code }}</td>
                                                <td class="tbl-column"> {{ voucher.name }}</td>
                                                <td class="tbl-column"> {{ voucher.capacity }}</td>
                                                <td class="tbl-column"> {{ voucher.duration }}</td>
                                                <td class="tbl-column"> {{ voucher.quota }}</td>
                        ...
                        <div class="flex justify-between items-center p-2 border-t border-slate-200 dark:border-slate-700">
                            <Pagination :links="props.vouchers" :filters="data.params" />
                        </div>
                    </div>                   
                </div>
            </div>            
