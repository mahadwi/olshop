...
// import Edit from "@/Pages/Color/Edit.vue";
import Delete from "@/Pages/Commission/Delete.vue";
                ...
                <div class="col-span-2">
                    ...
                    >
                                ...
                                <div class="overflow-hidden shadow">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        ...
                                        >
                                                ...
                                                <td class="tbl-column"> {{ commission.brand.name }}</td>
                                                <td class="tbl-column"> {{ commission.category }}</td>
                                                <td class="p-4 space-x-2 whitespace-nowrap">
                                                    <Link :href="route('commission.edit', commission.id)" class="btn-primary">
                        ...
                        <div class="flex justify-between items-center p-2 border-t border-slate-200 dark:border-slate-700">
                            <Pagination :links="props.commissions" :filters="data.params" />
                        </div>
                    </div>                   
                </div>
            </div>            
