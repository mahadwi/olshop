                ...
                <ul class="py-1" role="none">
                  <li>
                    <form action="{{ route('logout') }}" method="post" role="form">
                        @csrf
                        <button type="submit" class="text-left w-full block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">Log out</button>
                    </form>
